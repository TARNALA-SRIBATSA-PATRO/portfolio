        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="animate-fade-in" style={{ animationDelay: '0.2s' }}>
            ...
            <div className="space-y-4 text-gray-300 text-lg">
              <p>
                Hi! I'm <span className="text-orange-500 font-semibold">Tarnala Sribatsa Patro</span>, 
                a passionate 3rd-year B.Tech Computer Science and Engineering student at 
                <span className="text-orange-500"> Silicon University, Bhubaneswar</span>.
              </p>
              <p>
                I'm a <span className="text-orange-500 font-semibold">Full Stack Developer</span> skilled 
                in both frontend and backend technologies. My journey in tech is driven by an insatiable 
                curiosity to learn new technologies and solve complex problems through innovative web solutions.
              </p>
              <p>
                Beyond coding, I enjoy solving Rubik's cubes, playing piano, listening to music, and 
                developing creative projects that challenge my technical abilities. I believe in 
